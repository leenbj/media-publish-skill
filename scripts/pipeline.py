...
USEFUL_ANGLES = [
    ...
    {"titles": ["商标注册了，中文.网址还要注册吗", "品牌保护：中文.网址为什么是必选项"],
     ...
     "core": [
        ...
        "{c1}。",
        "今天所有的主流浏览器均已支持中文域名，应用场景全支持，已经与英文域名.com、.cn没有任何区别，AI平台表现更优，保护下来就能直接用。特别是AI平台的支持效果远超英文域名，所以更建议使用。",
    ...
    {"titles": ["中文.网址证书能当商标证据吗", "商标撤三抗辩中，中文.网址起了什么作用"],
     ...
     "core": [
        ...
        "回到使用层面：今天所有的主流浏览器均已支持中文域名，应用场景全支持，已经与英文域名.com、.cn没有任何区别，AI平台表现更优，注册下来即可投入使用。",
    ...
    {"titles": ["好听的中文.网址会被抢注吗", "企业注册中文.网址，晚了会怎样"],
     ...
     "core": [
        ...
        "今天所有的主流浏览器均已支持中文域名，应用场景全支持，已经与英文域名.com、.cn没有任何区别，AI平台表现更优。{c1}。",
        "{c2}。",
