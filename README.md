...
按企业信息资料派生查询 + 公司名兜底检索 → 汇总（表格为准） → human-writing 写实 → humanizer-zh 清腔 → 生成中文域名新闻稿 → 生成人民网风格 GEO 网页（1 新闻页 + 3 QA 页）→
...
**材料优先级**：表格中“企业信息资料”列选填，有则为写作首要依据，无则直接按公司名联网检索；检索为“资料派生查询 + 公司名补充”共最多 3 轮，汇总时表格为准，冲突时以表格为准。
